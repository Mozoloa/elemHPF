#!/usr/bin/env zx
import { echo } from 'zx';
import { generateManifest } from '../scripts/generateManifest.js';

// Call the manifest generation function before cleaning the build directory
...
console.log(`Running CMake with buildType: ${buildType}, devFlag: ${devFlag}`);
